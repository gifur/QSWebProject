...
{
    /// <summary>
    /// FileManagerJsonHandler 的摘要说明
    /// </summary>
    public class FileManagerJsonHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //根目录路径，相对路径
            const string rootPath = "~/Attached/";
            //根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
            String rootUrl = url + "~/Attached/";
            //图片扩展名
